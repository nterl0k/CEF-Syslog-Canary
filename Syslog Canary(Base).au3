...
; Enable the following options #AutoIt3Wrapper if using MetroUDF(Line 19,22,25)
...
; This UDF allows for local account enumeration
	; https://www.autoitscript.com/forum/topic/74118-local-account-udf/
#include "LocalAccount.au3"

; This UDF allows for Win10/Metro Styling of the final output, disabled by default.
	;https://www.autoitscript.com/forum/topic/161184-metrogui-udf-v51-windows-10-style-buttons-toggles-radios-menu-etc/
;#include "MetroGUI_UDF.au3"

;Built-in AutoIT Includes
#include <Array.au3>
#include <Date.au3>
#include <Inet.au3>
...
;Fake User/Password
	; Use only ONE of the following message box outputs, MetroUDF looks nicer but is more work to include so is disbaled by default.

	MsgBox(0, "Temp admin credentials", "Your one-time admin login account is: " & $account  & @CR & "The password is: " & $pwd)
	;_Metro_MsgBox(0,  "Temp admin credentials", "Your one-time admin login account is: " & $account  & @CR & "The password is: " & $pwd)
